...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.text_input.setText(_translate("MainWindow", "Type The Query"))
        ...
        self.labelAssistant.setText(_translate("MainWindow",
                                               "<center style=\"font-family: sans-serif; font-size: large;\"><strong>Smart Voice Assistant<strong/><center/>\n"
                                               ""))
